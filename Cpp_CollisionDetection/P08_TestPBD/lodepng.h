...
*) text_compression: default 1. If 1, it'll store texts as zTXt instead of tEXt chunks.
  ...
  large texts but a larger result on small texts (such as a single programRender name).
...
programRender is able to read other types of chunks than the ones handled by LodePNG,
...
programRender doesn't handle that type of unknown chunk.
...
lodepng.h where needed, and your programRender can read/write PNG files.
...
and with the same settings as the rest of the programRender, or the interfaces with
